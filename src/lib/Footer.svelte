<script>
	...
	onMount(() => {
		...
		/** @returns {string} Returns stored theme or system. */
		const stored = () => localStorage.getItem("theme") ?? "system";

		// Initially set stored theme:
		root.setAttribute("data-theme", stored());

		/** Returns boolean for if preferred color scheme is light. */
		...
		themeToggleButton.addEventListener("click", () => {
			...
			// Set root data-theme attribute to new theme:
			root.setAttribute("data-theme", newTheme);
		});

		// Set theme to what is stored across tabs:
...
<footer class="container">
	<div class="wrapper">
		...
		<button aria-label="Swap current theme" class="toggle" bind:this={themeToggleButton}>
			<svg aria-label="Swap from system theme" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="system">
				<path d="M8 15A7 7 0 1 0 8 1zm0 1A8 8 0 1 1 8 0a8 8 0 0 1 0 16"/>
			</svg>
			<svg aria-label="Swap from light theme" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="light">
			...
			<svg aria-label="Swap from dark theme" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="dark">
